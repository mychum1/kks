		...
		<form name="f" action="insertPro.member" method="post">
			<div class="form-group">
				...
				<div class="form-group" style="background-color: black;">
					<input type="text" name="id" class="form-control-1" id="id"	placeholder="id@mail.com" style="float: left;">
					<button type="button" class="btn btn-success" onclick="idCHK()" style="float: left;">인증번호 전송</button>
				</div>
			</div>
			<br> <br>
			<%
			...
			<div class="form-group" class="form-inline">
				<label for="CHK">인증번호</label> <br> 
				<input type="text"
					name="EmailCHK" class="form-control-1" id="CHK" placeholder="이메일 인증번호"
					style="float: left;">
				<samp>
			...
			<div class="form-group">
				<label for="password1">비밀번호</label> <input type="password"
					name="password" class="form-control-1" id="passwd1" placeholder="비밀번호">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="name">이름</label> <input type="text" name="name"
					class="form-control-1" id="name" placeholder="한글+영문 or 영문 + 한글 or 한글 or 영문 ">
			</div>
			...
			<div class="form-group">
				...
				<div class="btn-group input-group" data-toggle="buttons">
					...
					<input type="radio" id = "gender1" name="gender" checked="checked" value="남성">남성</label> <!-- 스타일풀어보면 체크 되어 있어요 -->
					<label class="btn btn-success">
					<input type="radio" id = "gender2" name="gender"  value="여성"/>여성</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group">
					<input type="text" name="birth" class="form-control-2"
						id="birthday" placeholder="YYYYMMDD">
				</div>
			</div>
			...
			<input type="checkbox"
				name="interest" id="chkbox1" onclick="chkBoxCheck(1)" value="카테고리2">카테고리2
			<input type="checkbox"
				name="interest" id="chkbox1" onclick="chkBoxCheck(2)" value="카테고리3">카테고리3
			</span>
...
회사는 필요한 경우 서비스 내의 개별항목에 대하여 개별약관 또는 운영원칙(이하 ‘서비스 별 안내’라 합니다.)를 정할 수 있으며, 회원은 각 서비스 별 안내에 대해 회원가입과 동시에 동의한 것으로 간주합니다. 본 약관과 서비스 별 안내의 내용이 상충되는 경우에는 서비스 별 안내의 내용을 우선하여 적용합니다.
				...
				<div class="checkbox">
					<label> <input type="checkbox" name="box">약관에 동의합니다.
					</label>
				</div>
			</div>
			<div class="form-group text-center">
				<button type="submit" class="btn btn-info" onclick="chk()">회원가입<i class="fa fa-check spaceLeft"></i> </button>
				<button type="button" class="btn btn-warning" onclick="location.href='main.app'"> 가입취소<i class="fa fa-times spaceLeft"></i> </button>
			</div>
		</form>
	</div>
